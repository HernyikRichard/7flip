...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-surface/90 backdrop-blur-md">
      <div
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? 'text-primary-500' : 'text-muted-foreground hover:text-foreground'
              )}
